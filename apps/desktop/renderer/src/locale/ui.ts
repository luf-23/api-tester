...
export const ui = {
  ...
  request: {
    ...
    settingsProxyCustom: 'Custom proxy',
    settingsProxyDirect: 'No proxy (direct)',
    settingsProxyHint: 'The system option follows your operating system proxy and PAC settings.',
    settingsProxyUrl: 'Proxy URL',
    settingsProxyUrlHint:
      'HTTP(S) proxy URL. Credentials may be included, for example http://user:pass@host:port.',
